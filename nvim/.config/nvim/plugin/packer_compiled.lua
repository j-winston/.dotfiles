...
_G.packer_plugins = {
  ...
  ["beacon.nvim"] = {
    loaded = true,
    path = "/home/james/.local/share/nvim/site/pack/packer/start/beacon.nvim",
  ...
  indentLine = {
    loaded = true,
    path = "/home/james/.local/share/nvim/site/pack/packer/start/indentLine",
  ...
  ["nvim-lint"] = {
    loaded = true,
    path = "/home/james/.local/share/nvim/site/pack/packer/start/nvim-lint",
  ...
  ["nvim-surround"] = {
    ...
    loaded = true,
    path = "/home/james/.local/share/nvim/site/pack/packer/start/nvim-surround",
  ...
  ["solarized.nvim"] = {
    loaded = true,
    path = "/home/james/.local/share/nvim/site/pack/packer/start/solarized.nvim",
  ...
  ["vim-startify"] = {
    loaded = true,
    path = "/home/james/.local/share/nvim/site/pack/packer/start/vim-startify",
